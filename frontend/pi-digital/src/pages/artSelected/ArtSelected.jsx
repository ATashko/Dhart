      ...
      <section className='w-full h-full'>
        ...
        >
          <article className='w-full grid'>
            ...
            <div className='w-full flex flex-col desktop:flex-row desktop:items-center gap-5 justify-between'>

              <div className="flex justify-center">
                <Calendar className=' w-full grid tablet:hidden tablet:w-full desktop:w-[65%] rounded-b-lg desktop:rounded-lg shadow-md p-5 border-none mx-auto' />
              ...
              <div className='desktop:w-[25%] desktop:h-32 desktop:bg-[#FFFFFF] rounded-lg desktop:shadow-md grid tablet:grid-cols-2 desktop:grid-cols-1 desktop:grid-rows-2 items-center p-5 gap-10 '>
                <p className='text-sm'>
                  ¡Obten tu obra de arte deseada con una reserva rápida!
                </p>
